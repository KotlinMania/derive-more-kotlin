// port-lint: tests into_iterator.rs
...
/**
 * Tests mirroring upstream into_iterator.rs.
 *
 * Upstream uses the IntoIterator derive to generate IntoIterator impls for
