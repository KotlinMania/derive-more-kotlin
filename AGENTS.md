...
This file is the quick-reference operating contract for derive-more-kotlin. The longer
...
derive-more-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`derive_more`](https://crates.io/crates/derive_more). Upstream Rust is the behavioral oracle while the
