...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `DeriveMore.swiftmodule/`
...
//      `import DeriveMore` above would fail at compile time.
//
//   2. The static archive `libDeriveMore.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "DeriveMore" }` and
//      `flattenPackage = "io.github.kotlinmania.derivemore"` configuration in
...
//      via the `DeriveMoreLibrary` product.
//
...
final class DeriveMoreExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "DeriveMore swift module imported cleanly")
    }
}
