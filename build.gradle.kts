...
kotlin {
    ...
    val xcf = XCFramework("DeriveMore")

    macosArm64 {
        binaries.framework { baseName = "DeriveMore"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "DeriveMore"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "DeriveMore"
        flattenPackage = "io.github.kotlinmania.derivemore"
    }

    android {
        namespace = "io.github.kotlinmania.derivemore"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "derive-more-kotlin", version.toString())

    pom {
        name.set("derive-more-kotlin")
        description.set("Kotlin Multiplatform port of JelteF/derive_more - Adds #[derive(x)] macros for more traits")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/derive-more-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/derive-more-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/derive-more-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/derive-more-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.derivemore.codeql
